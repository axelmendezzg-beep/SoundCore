...
object PoTokenGenerator {
    ...
    fun generateColdStartToken(identifier: String, clientState: String = ""): String {
        ...
        return Base64.encodeToString(tokenPayload, Base64.URL_SAFE or Base64.NO_WRAP or Base64.NO_PADDING).trimEnd('=')
    }

    fun generateContentToken(identifier: String, videoId: String): String = generateColdStartToken(identifier, videoId)
